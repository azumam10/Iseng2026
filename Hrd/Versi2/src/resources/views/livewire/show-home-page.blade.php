    ...
    <section id="hero" class="hero section light-background">
        ...
        <div class="position-relative container">
            <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
                <h2>{{ $setting->hero_title ?? 'WELCOME TO MEDILAB' }}</h2>
                <p>
                    {{ $setting->hero_description ?? 'Manufaktur perangkat medis dan manufaktur dan penjualan perangkat medis' }}
                </p>
            </div>
            <!-- End Welcome -->
            ...
            <div class="content row gy-4">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
                        <h3>Mengapa kami yang terbaik?</h3>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div>
                                ...
                                <p>
                                    Et velit et eos maiores est tempora et quos dolorem autem tempora incidunt maxime
                                    veniam
                                </p>
                            </div>
                        </li>
                        ...
                        <div class="tab-pane active show" id="departments-tab-1">
                            <div class="row">
                                <div class="col-lg-8 details order-lg-1 order-2">
                                    ...
                                    <p>
                                        Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum
                        ...
                        <div class="tab-pane" id="departments-tab-5">
                            <div class="row">
                                <div class="col-lg-8 details order-lg-1 order-2">
                                    ...
                                    <p>
                                        Exercitationem nostrum omnis. Ut reiciendis repudiandae minus. Omnis recusandae
                ...
                <div class="col-lg-10" data-aos="fade-up" data-aos-delay="100">
                    <div class="faq-container">
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>
                                    Enim ea facilis quaerat voluptas quidem et dolorem. Quis et consequatur non sed in
