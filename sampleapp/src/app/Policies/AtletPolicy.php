...
class AtletPolicy
{
    ...
    {
        return $user->can('view_any_atlet');
    }
    ...
    {
        return $user->can('delete_any_atlet');
    }
     ...
     */
    public function replicate(User $user, Atlet $atlet): bool
    {
