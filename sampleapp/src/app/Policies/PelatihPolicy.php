...
class PelatihPolicy
{
    ...
    {
        return $user->can('view_any_pelatih');
    }
    ...
    {
        return $user->can('create_pelatih');
    }
    ...
    {
        return $user->can('update_pelatih');
    }
    ...
    {
        return $user->can('delete_pelatih');
    }
    ...
    {
        return $user->can('delete_any_pelatih');
    }
     ...
     */
    public function replicate(User $user, Pelatih $pelatih): bool
    {
